...
foam.POM({
  ...
  files: [
    ...
    { name: "debug/PropertyEvent",                     flags: "web" },
    { name: "debug/ServiceEvent",                      flags: "web" },
    { name: "debug/WAOEvent",                          flags: "web" },
    ...
    { name: "debug/scenarios/PrerequisiteLoaderScenario", flags: "web&debug" },
    { name: "debug/scenarios/PrerequisiteWAOScenario",    flags: "web&debug" },
    ...
    { name: "axiom/CloseWindowWizardAction",           flags: "web" },
