...
const FP_BTEE_READ_CACHE:            BtreeReadFlag = 1 << 0; /* Only try to read from cache */
const FP_BTEE_READ_NO_WAIT:          BtreeReadFlag = 1 << 1; /* If the page is locked by other thread, return busy. */
