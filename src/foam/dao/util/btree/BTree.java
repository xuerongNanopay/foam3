...
public class BTree {
  ...
  public static <T> Object[] build(BTreeLoader<T> sortedBulk, int size) {
    assert size >= 0;
  ...
  private static <T> Object[] buildLeaf(BTreeLoader<T> sortedBulk, int size) {
  ...
  private static <T> Object[] buildInternal(BTreeLoader<T> sortedBulk, int size) {
   ...
   */
  private static <T> Object[] denselyBuild(BTreeLoader<T> sortedBulk, int tupleSize, int size, int height) {
   ...
   */
  private static <T> Object[] fullyBuild(BTreeLoader<T> sortedBulk, int height) {
